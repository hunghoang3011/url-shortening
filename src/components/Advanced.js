...
export default function Advanced() {
  return (
    <>
      <section className="bg-gray-100 pt-20 pb-10 lg:pb-40">
        <div className="max-width">
          ...
          <div className="relative card grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
            ...
            <article className="bg-white p-5 rounded relative">
              ...
              />
              <h3 className="text-slate-800 text-xl mb-3 font-bold mt-5">
                Brand Recognition
              </h3>
            ...
            <article className="bg-white p-5 rounded relative">
              ...
              <p className="text-slate-400 text-sm">
                ...
                when and where <br /> people engage with your content <br />
            ...
            <article className="bg-white p-5 rounded relative">
              ...
              <p className="text-slate-400 text-sm">
                ...
                through <br /> customizable links, supercharging <br /> audience
                engagement.
              </p>
            </article>
          </div>
